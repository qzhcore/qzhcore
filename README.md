<div align="center">
  ...
  <a href="https://github.com/qzhcore">
    <img src="https://komarev.com/ghpvc/?username=qzhcore&label=profile+views&color=161616&style=flat" alt="Profile Views" />
  </a>
  &nbsp;
  <a href="https://github.com/qzhcore">
    <img src="https://img.shields.io/github/followers/qzhcore?label=followers&style=flat&color=161616&labelColor=0d0d0d" alt="GitHub Followers" />
  </a>
...
<p>Hey, I'm qzhl. I'm a software engineer, multistack programmer, and game studio owner focused on building systems, web infrastructure, and high-performance game architectures. I work with low-level languages like Rust and C++, write scalable web tools, and run production titles under <a href="https://discord.gg/P9YVDujmfJ"><b>Darkk Games</b></a>.</p>

<p>Right now, I'm leading development on <b>Anime Starfall</b> (an anime tower defense title on Roblox) while laying down the foundation for future studies toward a Doctor of Business Administration.</p>
...
<ul>
  <li><b>Languages:</b> Luau • TypeScript • C++ • Rust • Go • Python • Assembly • C • PHP</li>
  <li><b>Game Development:</b> Roblox Studio • Luau • Unity • Unreal Engine</li>
  <li><b>Web & Infrastructure:</b> Node.js • Express • React • AWS • Docker • Linux • PostgreSQL • Redis</li>
  <li><b>Tooling & AI:</b> Git • GitHub Actions • PyTorch • Ollama • Blender</li>
</ul>
...
<blockquote align="center">
  <p>Independent Roblox game studio. Currently developing <b>Anime Starfall</b>.</p>
</blockquote>
